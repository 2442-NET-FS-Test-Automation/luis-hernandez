...
{
    // Our InventoryService is what will call repo layer methods, so it gets that dependcy, not the controller
    ...
    // When you first start writing your API, and you just want to make sure DB access is working, and get the skeleton/structure up - your method will be very "lean" that's okay
    ...
    {
        // This is going to need a DTO - we'll return
