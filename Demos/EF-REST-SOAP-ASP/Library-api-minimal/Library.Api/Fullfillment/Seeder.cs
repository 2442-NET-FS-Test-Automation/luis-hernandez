...
{
    IReadOnlyCollection<int> SeedOrders(int n, bool expedited);
...
public class Seeder : ISeeder
{
    ...
    private static readonly string[] Skus = { "BK-001", "BK-002" }; 
    ...
    public IReadOnlyList<int> ResetAndCreateOrders(int n)
    {
        ...
        foreach (InventoryItem inv in db.Inventory)
        {
            ...
            {
                case 1: inv.CurrentStock = 5; break;
                case 2: inv.CurrentStock = 3; break;
                case 3: inv.CurrentStock = 8; break;
                default: break;
            }
        }
    ...
    public IReadOnlyCollection<int> SeedOrders(int n, bool expedited)
    {
